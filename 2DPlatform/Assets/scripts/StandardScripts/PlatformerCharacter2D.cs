...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
		...
		private Transform PlayerGraphics; 	// reference to the Graphics to we can change direction
        ...
        private void Awake()
        {
			...
			if (PlayerGraphics == null) {
				Debug.LogError ("There is no Graphics object as a child of Player");
			}
        }
        ...
        private void FixedUpdate()
        {
			...
			// state has changed and we are on ground
